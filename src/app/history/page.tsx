        ...
        <div className="mx-auto max-w-4xl">
          ...
          <section aria-labelledby="recent-heading" className="mt-16">
            ...
            <div className="space-y-16 sm:space-y-24">
              {orders?.map((order) => {
                const statusColor = order.status === "SUCCESS" ? "green" : order.status === "FAIL" ? "red" : "yellow";
                return (
                  <div key={order.tid}>
                      ...
                      <dl
                        ...
                        <div className="flex justify-between pt-4 md:block md:pt-0">
                          ...
                          <dd className="md:mt-1">
                            <time dateTime={order.dateTime.toString()}>{order.dateTime.toString()}</time>
                          </dd>
                        </div>
                            ...
                            <div className="min-w-0 flex-1 lg:flex lg:flex-col">
                              <div className="lg:flex-1">
                                <div className="sm:flex">
                                  ...
                                  <p
                                    className="mt-1 font-medium text-gray-900 sm:ml-6 sm:mt-0">$ {item.product.price}</p>
                                </div>
